// API URLs
export const API_BASE_URL = import.meta.env.VITE_API_CRUDS_URL || 'http://localhost:4900'//'http://localhost:4900';
export const API_BASE_SOFIA = import.meta.env.VITE_API_SOFIA_URL || 'http://localhost:4500'; 
export const API_BASE_SOFIA_CHAT = import.meta.env.VITE_API_SOFIA_CHAT_URL || 'http://localhost:3300'; 
// API endpoints
export const ENDPOINTS = {
  ...
  inventoryWarehouse: {
    base: `${API_BASE_URL}/warehouse`,
    byId: (id: string | number) => `${API_BASE_URL}/warehouse/${id}`,
    byName: (name: string) => `${API_BASE_URL}/warehouse/byName/${name}`,
    findAll: `${API_BASE_URL}/warehouse/findAll`,
    central: `${API_BASE_URL}/warehouse/central`,
    property: `${API_BASE_URL}/warehouse/property`,
    byPropertyId: (propertyId: string) => `${API_BASE_URL}/warehouse/byPropertyId/${propertyId}`,
  },
  inventoryProduct: {
    base: `${API_BASE_URL}/product`,
    byId: (id: string | number) => `${API_BASE_URL}/product/${id}`,
    byName: (name: string) => `${API_BASE_URL}/product/byName/${name}`,
    findAll: `${API_BASE_URL}/product/`,
    withLots: (id: string | number) => `${API_BASE_URL}/product/withLots/${id}`,
    stockLevels: (id: string | number) => `${API_BASE_URL}/product/stockLevels/${id}`,
    secondary: `${API_BASE_URL}/product/secondary`,
  },
  inventoryLot: {
    base: `${API_BASE_URL}/lot`,
    byId: (id: string | number) => `${API_BASE_URL}/lot/${id}`,
  ...
  inventoryMovement: {
    base: `${API_BASE_URL}/inventoryMovement`,
    byId: (id: string | number) => `${API_BASE_URL}/inventoryMovement/${id}`,
    byName: (name: string) => `${API_BASE_URL}/inventoryMovement/byName/${name}`,
    findAll: `${API_BASE_URL}/inventoryMovement/findAll`,
    // Query endpoints
    byProductId: (productId: string) => `${API_BASE_URL}/inventoryMovement/byProductId/${productId}`,
    byLotId: (lotId: string) => `${API_BASE_URL}/inventoryMovement/byLotId/${lotId}`,
    history: (warehouseId: string, productId: string) => `${API_BASE_URL}/inventoryMovement/history/${warehouseId}/${productId}`,
    completeHistory: (productId: string) => `${API_BASE_URL}/inventoryMovement/completeHistory/${productId}`,
    exportReport: (productId: string) => `${API_BASE_URL}/inventoryMovement/exportReport/${productId}`,
    // Operations endpoints  
    assign: `${API_BASE_URL}/inventoryMovement/assign`,
    consume: `${API_BASE_URL}/inventoryMovement/consume`,
    move: `${API_BASE_URL}/inventoryMovement/move`,
    manualChange: `${API_BASE_URL}/inventoryMovement/manualChange`,
    restore: `${API_BASE_URL}/inventoryMovement/restore`,
  },
  inventoryInvoice: {
    base: `${API_BASE_URL}/invoice`,
    byId: (id: string | number) => `${API_BASE_URL}/invoice/${id}`,
    byInvoiceNumber: (number: string) => `${API_BASE_URL}/invoice/byInvoiceNumber/${number}`,
