...
/**
 * Reglas de campos para trabajo agricola
 * 
 * Este archivo define las reglas de reactividad entre campos para los formularios
 * de trabajo agricola, tanto para el wizard como para el formulario principal.
 */

export const trabajoAgricolaRules: FormGridRules = {
  rules: [
 ...
 */
export const createTrabajoAgricolaRules = (externalData: {
  ...
  return {
    ...trabajoAgricolaRules,
    externalData: {
      ...trabajoAgricolaRules.externalData,
      ...externalData
    }
  };
};
